...
import { services, courses, icons } from '../data';
      ...
      <section className="section-pad">
        <div className="container-px">
          <SectionHeading
            ...
            title={<>Six core services, <span className="text-gradient">one reliable partner</span></>}
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide ring-1 ${levelStyles[c.levelKey]}`}>
                      {c.level}
                    </span>
                  </div>
